...
` +
  ...
  function fv(e, t) {
    ...
    var l = Sm(),
      n = xm();
    Ne !== e || ue !== t ? (($c = null), (Vc = _t() + 500), pn(e, t)) : (yn = Hn(e, t));
    e: do
      try {
        if (be !== 0 && ce !== null) {
          t = ce;
  ...
  function wm() {
    ...
    try {
      ...
      var i = Za,
        f = xa;
      if (((Ye = 0), (_n = Za = null), (xa = 0), (ye & 6) !== 0)) throw Error(o(331));
      var v = ye;
      if (
        ((ye |= 4),
        dm(i.current),
  ...
  function mv(e, t, a) {
    ...
    (l !== null && l.delete(t),
      ...
      Ne === e &&
        (ue & a) === a &&
        (Re === 4 || (Re === 3 && (ue & 62914560) === ue && 300 > _t() - Gc)
          ? (ye & 2) === 0 && pn(e, 0)
          : (oo |= a),
        gn === ue && (gn = 0)),
      la(e));
...
function q3({ overridePatches: c }) {
  const u = X((z) => z.patches),
    ...
    [y, g] = de.useState(Math.min(h, cr - 1)),
    _ = N1(d, y + 1),
    b = _.length > 0,
    T = () => {
      if (c) return;
      ...
      r.jsxs('div', {
        ...
        children: [
          ...
          r.jsxs('div', {
            ...
            children: [
              r.jsx(D3, { value: y, min: 1, max: cr - 1, onChange: g }),
              r.jsxs(G, {
                variant: 'caption',
                color: 'dim',
